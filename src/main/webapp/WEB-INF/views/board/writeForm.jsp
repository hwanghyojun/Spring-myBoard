...
<script type="text/javascript"
	src="../resources/js/naver_smart_editor2/js/service/HuskyEZCreator.js"
								...
								<div class="row">
									<form id="write" action="write" method="post">
										<div class="input-group">
											...
											</span> <input readonly id="id" type="text" class="form-control"
												name="id" value="${login_session.u_id}">
										</div>
										<div class="input-group">
											<span class="input-group-addon">제목</span> <input id="title"
